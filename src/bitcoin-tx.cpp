...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s abc-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  abc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded abc transaction") + "\n" +
              "  abc-tx [options] -create [commands]   " + _("Create hex-encoded abc transaction") + "\n" +
              "\n";
