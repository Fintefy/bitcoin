...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s acs-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  acs-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded acs transaction") + "\n" +
              "  acs-tx [options] -create [commands]   " + _("Create hex-encoded acs transaction") + "\n" +
              "\n";
