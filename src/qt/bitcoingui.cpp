...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and acs: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a acs: URI or payment request"));
...
{
    QString strTitle = tr("Apicoureios"); // default title
