...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Check for untranslated substitution to make sure Apicoureios copyright is not removed by accident
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Apicoureios") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Apicoureios developers";
    }
